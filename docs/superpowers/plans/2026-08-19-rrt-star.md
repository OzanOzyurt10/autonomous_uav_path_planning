...
- [ ] **Adım 3: `_choose_parent`'ı yaz — OZAN**
...
- [ ] **Adım 1: Mevcut testleri güncelle — CLAUDE**
...
- [ ] **Adım 4: Doğrulamayı genişlet — OZAN**
...
- [ ] **Adım 6: Testi çalıştır, geçtiğini gör — CLAUDE**
