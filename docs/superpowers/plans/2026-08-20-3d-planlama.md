...
## Durum (2026-08-20 sonu)

Faz A bitti ve commit'lendi: `environment3d.py` calisiyor, 46 test.
Toplam 394 test geciyor.

Gorev 5'in testleri yazildi ve kirmizi; siradaki is `src/rrt_star3d.py`
dosyasini acip `Node3` ve `RRTResult3`'u yazmak (OZAN).
...
STEP = 2.0
START = (10.0, 50.0, 40.0, 0.0)
GOAL = (90.0, 50.0, 40.0, 0.0)
...
- [ ] **Adım 3: `_neighbour_radius`'u yaz — OZAN**
